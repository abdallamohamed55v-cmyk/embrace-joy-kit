...
const STEPS: Step[] = [
  { id: "chat", label: "أول محادثة", icon: MessageSquare, href: "/chat" },
  { id: "image", label: "أول صورة", icon: ImageIcon, href: "/image" },
  { id: "doc", label: "أول مستند / سلايد", icon: FileText, href: "/slides" },
  { id: "invite", label: "ادعُ صديقاً", icon: Users, href: "/billing/referrals" },
  { id: "pro", label: "فعّل Pro بخصم 50%", icon: Crown, href: "/pricing?promo=WELCOME50" },
];
...
export default function OnboardingChecklist() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[100] hidden md:block" dir="rtl">
      <AnimatePresence mode="wait">
        {open ? (
          ...
          >
            <div className="px-4 py-3 border-b border-border flex items-center justify-between bg-gradient-to-l from-primary/10 to-transparent">
              <div className="flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-primary" />
                <div className="text-sm font-bold">ابدأ مع Megsy</div>
              </div>
                ...
                return (
                  <li key={s.id}>
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-2.5 py-2.5 rounded-lg text-sm text-right transition-colors ${
