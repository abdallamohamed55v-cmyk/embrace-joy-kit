      ...
      await new Promise<void>((resolve) => {
        const unsub = subscribeJob(jobId, {
          ...
          onDone: () => {
            ...
            // Always rebuild the preview when streaming ends and the project
            // has files. fileEvents may be empty if the agent skipped writes,
            // but the latest DB state is still what should be on Cloudflare.
            if (projectId) {
              void deploy("preview");
            }
            unsub();
          ...
          <button
            ...
            onClick={() => {
              ...
              try {
                ...
                // Blank first to force a clean teardown, then reload with cache-bust
